...
export class DeckView extends ContainerView {
    constructor(data) {
        ...
        this.bg.drawRoundedRect(-ClassicCardView.width / 2 - PLUS_SIZE, -ClassicCardView.height / 2 - PLUS_SIZE, ClassicCardView.width + PLUS_SIZE * 2, ClassicCardView.height + PLUS_SIZE * 2, 8);
