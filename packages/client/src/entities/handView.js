...
export class HandView extends EntityView {
    constructor(data) {
        ...
        this.bg.drawRoundedRect(-ClassicCardView.width / 2 - PLUS_SIZE * 2, -ClassicCardView.height / 2 - PLUS_SIZE, ClassicCardView.width + PLUS_SIZE * 4, ClassicCardView.height + PLUS_SIZE * 2, 32);
...
const labelText = (data) => `${data.type} (${Object.keys(data.children).length})`;
